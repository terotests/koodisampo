...
const ADULT_JOKES = [
  ...
  "Palaveri olisi voinut olla sähköposti. Sähköposti olisi voinut olla Slack-viesti. Slack-viesti olisi voinut jäädä lähettämättä.",
  "'Pieni muutos' on tuotepäällikön tapa sanoa 'uusi arkkitehtuuri'.",
  "Arvioimme taskin kahdeksi tunniksi. Kolmantena päivänä arvioimme sen uudelleen kahdeksi tunniksi.",
  "Rakastan deadlineja. Erityisesti sitä suhahdusta, kun ne viuhahtavat ohi.",
  "Projekti oli 90 % valmis. Sitten alkoi toinen 90 %.",
  "Maailmassa on 10 tyyppiä ihmisiä: ne jotka ymmärtävät binääriä, ja ne jotka eivät.",
  "Haluatko kuulla TCP-vitsin? — Joo. — Oletko varma? — Olen. — Okei, kerron nyt TCP-vitsin.",
  "Kerroin UDP-vitsin. Ihan sama, menikö se perille.",
  "Ohjelmoinnissa on vain kaksi vaikeaa asiaa: välimuistin mitätöinti, nimeäminen ja off-by-one-virheet.",
  "Ohjelmoija jäi suihkuun ikuisesti. Shampoopullossa luki: pese, huuhtele, toista.",
  "Sain ohjeen: 'osta maitoa, ja jos niillä on kananmunia, ota kuusi.' Toin kuusi purkkia maitoa.",
  "Miksi ohjelmoija sekoittaa joulun ja halloweenin? Koska OCT 31 == DEC 25.",
  "Ymmärtääksesi rekursion sinun on ensin ymmärrettävä rekursio.",
  "!false — hauska, koska se on totta.",
  "Ei ole paikkaa kuin 127.0.0.1.",
  "99 pientä bugia koodissa. Korjaat yhden, ajat testit: 117 pientä bugia koodissa.",
  "Heisenbug: bugi, joka katoaa heti kun avaat debuggerin.",
  "Koodissa luki kommentti: 'Älä koske, tämä toimii.' Nyt kumpikaan ei pidä paikkaansa.",
  "Optimisti: lasi on puoliksi täynnä. Pessimisti: puoliksi tyhjä. Insinööri: lasissa on sataprosenttinen ylimitoitus.",
  "Schrödingerin deploy: tuotanto on samaan aikaan pystyssä ja alhaalla, kunnes joku avaa monitoroinnin.",
  "Dokumentaatio on rakkauskirje tulevalle itsellesi. Siksi sitä ei kirjoita kukaan.",
  "C++:ssa friend-luokka pääsee käsiksi privaattijäseniisi. Aivan kuten oikeatkin ystävät.",
  "C kysyi C++:lta: oletko onnellinen? C++ vastasi: riippuu, miten onnellisuus on ylikuormattu.",
  "Uusi C++-standardi selkeytti alustamista lisäämällä neljä uutta tapaa alustaa muuttuja.",
  "Segfault on C++:n tapa sanoa: annoin sinulle vapauden, ja näin sinä sen käytit.",
  "Miksi C++-ohjelmoija ei pelkää loppua? RAII — kaikki siivotaan scopen lopussa.",
  "typeof NaN on 'number', vaikka NaN tarkoittaa 'ei numero'. JavaScript, meidän pitää jutella.",
  "NaN katsoi peiliin eikä tunnistanut itseään. NaN !== NaN.",
  "JavaScriptissä '2' + 2 on '22' ja '2' - 2 on 0. Siksi on olemassa TypeScript — ja terapia.",
  "JavaScript-kehittäjä meni terapiaan, koska ei tiennyt, mikä 'this' oikeastaan on.",
  "npm install lataa puolet internetistä, jotta voit tulostaa 'Hello World'.",
  "SQL-kysely kävelee baariin, astelee kahden pöydän luo ja kysyy: saanko liittyä seuraanne?",
  "Kolme DBA:ta käveli NoSQL-baariin. He kääntyivät ovella pois — ei yhtään vapaata taulua.",
  "Juniori ajoi DELETEn ilman WHEREä. Sitä päivää muistelevat kaikki — paitsi tietokanta.",
  "SELECT * meni juhliin ja toi mukanaan koko suvun.",
  "EXPLAIN ANALYZE kertoo totuuden. Siksi sitä ajetaan niin harvoin.",
  "'Toimii mun koneella.' — 'Hyvä, pakataan sun kone ja toimitetaan asiakkaalle.' Näin syntyi Docker.",
  "chmod 777 ratkaisee oikeusongelman ja aloittaa tietoturvaongelman samalla komennolla.",
  "Kysyin Linuxilta apua. Se sanoi: lue manuaali. Manuaali sanoi: katso lähdekoodi. Lähdekoodi sanoi: onnea matkaan.",
  "Cron ajoi työn täsmälleen ajallaan — väärällä aikavyöhykkeellä.",
  "latest ei ole versionumero, se on tunnetila.",
  "Qt:ssä jokainen olio on jonkun lapsi, ja kun parent tuhoutuu, lapsetkin siivotaan. Perhearvot kunnossa.",
  "Signaali lähti, mutta slot oli väärässä säikeessä. Vähän niin kuin meidän tiimipalaverit.",
  "'Kokoo koko kokko kokoon.' 'Koko kokkoko?' 'Koko kokko.' Suomi näyttää välillä korruptoituneelta muistivedokselta.",
  "'Kuusi palaa' voi tarkoittaa ainakin yhdeksää eri asiaa. Suomi on kieli, jossa parseri tarvitsee kontekstin.",
  "Suomi on vahvasti tyypitetty kieli: 'isoäiti' ja 'iso äiti' ovat eri oliot.",
  "Koodari ihastui suomeen: vihdoin luonnollinen kieli, jossa sanat ovat yhtä pitkiä kuin Javan muuttujanimet.",
  "Pyysin tekoälyä kertomaan vitsin. Se pyysi anteeksi ja tarjosi viisi vaihtoehtoista tapaa olla hauska.",
];
const KIDS_JOKES = [
  "Mikä on maailman suurin riisi? Pariisi.",
  "Mikä on maailman pisin sana? Kumi — sen voi venyttää vaikka kuinka pitkäksi.",
  ...
  "Miksi kuutonen pelkäsi seitsemää? Koska seitsemän söi yheksän.",
  "Mikä on keltainen ja veden alla? Sitruuna sukellusveneessä.",
  "Mikä on vihreä ja roikkuu puussa? Raaka apina.",
  "Mikä on punainen ja roikkuu puussa? Sama apina ruskettuneena.",
  "Miksi porkkana itki junassa? Se istui sipulin vieressä.",
  "Miksi kissa istui tietokoneen päällä? Se vahti hiirtä.",
  "Miksi tietokone aivasti? Sillä oli virus.",
  "Miksi tietokone myöhästyi koulusta? Se kaatui matkalla.",
  "Mitä hiiri sanoi tietokoneelle? Kiva kun me klikataan yhteen.",
  "Miksi kalat ovat huonoja tietokoneella? Ne pelkäävät verkkoa.",
  "Mikä on käärmeen lempiohjelmointikieli? Python.",
  "Miksi robotti meni lomalle? Sen piti ladata akkuja.",
  "Miksi matkapuhelin meni silmälääkäriin? Se oli hukannut kontaktinsa.",
  "Mikä on lehmän kännykän merkki? Muu-kia.",
  "Mikä on lampaan lempioppiaine? Määtematiikka.",
  "Mikä on matemaatikon lempiherkku? Piirakka.",
  "Miksi kirja meni sairaalaan? Siltä oli mennyt selkä.",
  "Mitä etana sanoi kilpikonnan kyydissä? Hurjaa vauhtia!",
  ...
  "Miksi dalmatialaisella on pilkut? Koska eihän se raidoilla olisi dalmatialainen vaan seepra.",
  "Miksi aave oli huono valehtelemaan? Sen läpi näki heti.",
  "Mitä lumiukko sanoi toiselle lumiukolle? Haistatko sinäkin porkkanan?",
  "Mikä kulkee ympäri maailmaa mutta pysyy koko ajan nurkassa? Postimerkki.",
];
