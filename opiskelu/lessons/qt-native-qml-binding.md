...
**Oikea vastaus:** Property binding kuten text: model.count.toString()

QML binding seuraa riippuvuuksia ja päivittyy, kun notify-signaali laukeaa.

Kertaluonteinen asetus ei reagoi muutoksiin. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: Aseta teksti kerran Component.onCompletedissä; Kutsu repaint C++:sta joka sekunti.
