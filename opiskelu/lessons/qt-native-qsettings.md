...
**Oikea vastaus:** QSettings

QSettings käyttää alustalle luontevaa asetustallennusta.

TemporaryFile ei ole pysyvä asetussäilö. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: QTemporaryFile pysyville asetuksille; QPainter asetusten serialisointiin.
...
[Lue lisää](https://doc.qt.io/qt-6/qsettings.html)
