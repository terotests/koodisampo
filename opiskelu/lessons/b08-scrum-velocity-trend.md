...
Ohjaa johtoa **tulosmittareihin**: valmis inkrementti, asiakasarvoa, laatu ja flow-mittarit (cycle time, WIP). Jos kapasiteettia arvioidaan, käytä qualitatiivista arviota ja tiimin omaa trendiä — ei ristiin vertailua. Scrum Master voi kieltäytyä jakamasta velocity-dataa tiimien rankingiin. Korosta, että "korkea velocity" ilman arvoa on tyhjä signaali.
