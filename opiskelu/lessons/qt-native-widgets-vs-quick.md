...
**Oikea vastaus:** Qt Widgets on usein nopea perinteiseen desktop-UI:hin; Qt Quick sopii dynaamisempiin/animoituihin näkymiin

Valinta riippuu UI:n luonteesta ja tiimin osaamisesta.

Qt 6 tukee sekä Widgets- että Quick-pohjaisia sovelluksia. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: Qt Widgets on poistettu Qt 6:ssa; Qt Quick toimii vain mobiilissa.
