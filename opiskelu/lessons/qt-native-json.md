...
**Oikea vastaus:** QFile + QJsonDocument

QJsonDocument on Qt:n JSON-parseri ja serializer.

Kuvan tai SQL:n API ei korvaa JSON-parseria. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: QPixmap koska JSON on tekstiä; QSqlQuery ilman tietokantaa.
