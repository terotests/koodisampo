# Tauri-sovellus exposeeraa komentoja frontendille. Mikä on turvallinen periaate?
...
**Oikea vastaus:** Salli vain tarvittavat capabilityt/komennot ja validoi syötteet backendissä

Pienin oikeus ja syötteen validointi ovat Tauri-turvan perusta.

Paikallinen sovellus voi silti kärsiä XSS:stä ja vääristä oikeuksista. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: Exposeeraa koko shell API frontendille; Poista CSP koska sovellus on paikallinen.
