# Milloin web-kuori EI riitä ja tarvitaan Compose/Qt?
...
**Oikea vastaus:** Kun tarvitaan syvä natiivi-integraatio, parempi suorituskyky tai offline ilman WebView-rajoja

Kuori on pragmatismi; natiivi on investointi pariteettiin ja UX:ään.

Väärät vaihtoehdot johtavat yleensä johonkin näistä ongelmista: Aina — web-kuori on vain demo; Kun pelissä on alle 10 kysymystä. Monelle pelille web-kuori on tuotantokelpoinen.
...
[Lue lisää](https://capacitorjs.com/docs/v3/plugins)
