# Jos RN:ää käytetään silti, missä Ranger-logiikan pitäisi ajaa?
...
**Oikea vastaus:** Native module (Kotlin/Swift) — JS kutsuu handleKey/snapshot, ei pelisääntöjä JS:ssä

Ohut JS, paksu natiivi — päinvastoin kuin tyypillinen RN-sovellus.

Väärät vaihtoehdot johtavat yleensä johonkin näistä ongelmista: Redux store pelilogiikalla; Hermes bytecode generoitu Rangerista. Pelisäännöt JS:ssä = kolmas kopio web+Kotlin rinnalle.
