...
**Oikea vastaus:** QObject event filter tekstikentälle

Event filter voi käsitellä tapahtuman ennen kohdeobjektia.

Globaali hook on ylimitoitettu ja alustariippuvainen. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: Globaali käyttöjärjestelmän keyboard hook aina; Muokkaa Qt:n lähdekoodia.
...
[Lue lisää](https://doc.qt.io/qt-6/eventsandfilters.html)
