# content/question-banks/*.json Qt-hostissa — miten ladataan?
...
**Oikea vastaus:** QFile + QJsonDocument — sama JSON kuin web/Node fetch

Data-driven sisältö pysyy JSONissa kaikilla hosteilla.

Väärät vaihtoehdot johtavat yleensä johonkin näistä ongelmista: JSON pitää muuntaa .ui-tiedostoiksi; Qt ei tue JSONia natiivisti. QJsonDocument on Qt:n standarditapa lukea pankit.
...
[Lue lisää](https://doc.qt.io/qt-6/qjsondocument.html)
