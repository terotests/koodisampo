# UI-komponentin eri tiloja halutaan tarkastella ilman sovelluksen käynnistämistä. Mikä Compose-työkalu auttaa?
...
**Oikea vastaus:** @Preview annotaatio ja erilliset preview-parametrit

Preview nopeuttaa UI-kehitystä, kun komponentti on riippuvuuksiltaan kevyt.

Preview ei korvaa testejä, mutta vähentää käsin ajamista. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: AndroidManifest activity-alias; ProGuard-sääntö jokaiselle tilalle.
...
[Lue lisää](https://developer.android.com/develop/ui/compose/tooling/previews)
