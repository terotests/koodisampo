# Sovellus tallentaa pieniä asetuksia paikallisesti. Mikä on tyypillinen ratkaisu?
...
**Oikea vastaus:** AsyncStorage tai alustaan sopiva turvallinen storage kirjasto tarpeen mukaan

Pienet asetukset sopivat AsyncStorageen; salaisuudet vaativat turvallisemman varaston.

Komponentin state häviää sovelluksen sulkeutuessa. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: Kirjoita asetukset komponentin stateen pysyvästi; Tallenna salaisuudet plaintext AsyncStorageen aina.
...
[Lue lisää](https://react-native-async-storage.github.io/async-storage/)
