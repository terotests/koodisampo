# Compose Navigationissa detail-näkymä tarvitsee tietueen id:n. Mikä on turvallinen malli?
...
**Oikea vastaus:** Välitä vain id navigointireitissä ja hae data ViewModelissa

Pienet argumentit pitävät reitit vakaina ja palautettavina.

Koko objektin kuljettaminen navigaatiossa tekee palautuksesta ja deeplinkeistä hauraita. Tyypillisiä vääriä suuntia tässä tilanteessa ovat esimerkiksi: Serialisoi koko tietue reittimerkkijonoon; Tallenna valittu objekti globaaliin muuttujaan.
...
[Lue lisää](https://developer.android.com/develop/ui/compose/navigation)
